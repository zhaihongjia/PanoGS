...
def render(
    ...
    # if colors_precomp is not None:
        # gs_language_feat = pc.get_language_feat
        # features_precomp = torch.cat((colors_precomp, gs_language_feat), dim=1)

    # Rasterize visible Gaussians to image, obtain their radii (on screen).
    if mask is not None:
        rendered_image, depth, opacity, radii = rasterizer(
        ...
        rendered_image, depth, opacity, radii = rasterizer(
            ...
            means2D=means2D,
            shs=shs,
            colors_precomp=colors_precomp, # features_precomp colors_precomp
            opacities=opacity,
            scales=scales,
            rotations=rotations,
    ...
    return {
        ...
        # "language_feat": rendered_image[3:, :, :],
