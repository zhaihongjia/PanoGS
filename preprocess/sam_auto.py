...
def main(args: argparse.Namespace):
    ...
    generator = SamAutomaticMaskGenerator(sam_model, output_mode=output_mode, **amg_kwargs)
    ...
    # save dir
    vis_dir = os.path.join(args.output_dir, 'sam', 'vis_color')
    raw_dir = os.path.join(args.output_dir, 'sam', 'raw')
